...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "UnitedBitcoin-seeder\n"
...
extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("47.254.197.11", 9333), true);
	db.Add(CService("47.74.149.139", 9333), true);
  	db.Add(CService("47.91.28.181", 9333), true);
  	db.Add(CService("47.104.84.238", 9333), true);
	db.Add(CService("47.88.60.63", 9333), true);
	db.Add(CService("47.90.101.236", 9333), true);
	db.Add(CService("120.79.171.137", 9333), true);
	db.Add(CService("119.23.240.234", 9333), true);
	db.Add(CService("121.43.182.123", 9333), true);
	db.Add(CService("47.97.178.192", 9333), true);
	db.Add(CService("39.107.67.188", 9333), true);
